...
const Login = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError('Erreur de réseau ou serveur indisponible');
    } finally {
      setLoading(false);
    }
    */

    // Simulation temporaire (à supprimer quand vous implémentez le backend)
    setTimeout(() => {
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mt-6">
          ...
          <p className="text-xs text-gray-500 mt-2">
            ...
            <br />
            <Link to="/privacy" className="hover:text-gray-700">Politique de confidentialité</Link>
            {' • '}
